namespace Warehouse.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Warehouse.DataAccess.WarehouseContext>
    {
        ...
        protected override void Seed(Warehouse.DataAccess.WarehouseContext context) // in Seed heter context
        {
            ...
            context.Products.AddOrUpdate(
                ...
                new Product { Name = " Ipad Helium", Category = "Electronics", Price = 5199, Count = 2 }
